...
users = {
    "priya": {"name": "Roshan Manandhar", "role": "BCA Student", "batch": "5th Sem"},
...
def home():
    ...
    return render_template('index.html', title="Home - Python Notebook")

@app.route('/about')
def about():
    """About page - explains this project"""
    return render_template('about.html', title="About - Python Notebook")
...
def topic_detail(topic_id):
    ...
    return render_template('topic_detail.html', title=f"{topic['name']} - Python Notebook", topic=topic)
